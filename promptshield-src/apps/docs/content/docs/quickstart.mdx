...
# Required: PROMPTSHIELD_PROVIDER=openai-compatible
# Required: PROMPTSHIELD_OPENAI_COMPATIBLE_UPSTREAM_URL=http://bifrost:8081/v1
...
Point your app at `http://localhost/v1`. The API is OpenAI-compatible, so existing client code usually does not need changes.
