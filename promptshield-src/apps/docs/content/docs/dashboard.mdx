---
title: Dashboard
description: Web UI for managing PromptShield policy, audit, gateway security config, and Bifrost router status.
---
...
- Manage application API keys and assign per-key policies
- Configure gateway and engine URLs for PromptShield security settings
- Open Bifrost for provider routing, model routing, and provider API keys
